...
import static org.apache.xmpbox.type.JobType.URL;
...
public class EnvDataConfig {
    ...
    public int getAppiumMediumWaitInSeconds() {
        return Integer.parseInt(getEnvProperties().getProperty(APPIUM_MEDIUM_WAIT_IN_SECONDS));
    }

    public int getAppiumLongWaitInSeconds() {
        return Integer.parseInt(getEnvProperties().getProperty(APPIUM_LONG_WAIT_IN_SECONDS));
    }

    public String getAppActivationCode() {
        return getEnvProperties().getProperty(APP_ACTIVATION_CODE);
    }
